...
try {
	...
	if (tools.length !== 75) throw new Error(`normal MCP request returned ${tools.length} tools; expected 75`);
	await client.close();

	console.log("✓ oversized chunked POST rejected with 413");
	console.log("✓ normal MCP initialization still advertises 75 tools");
} finally {
