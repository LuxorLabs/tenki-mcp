...
try {
	...
	if (tools.length !== 71) throw new Error(`normal MCP request returned ${tools.length} tools; expected 71`);
	await client.close();

	console.log("✓ oversized chunked POST rejected with 413");
	console.log("✓ normal MCP initialization still advertises 71 tools");
} finally {
