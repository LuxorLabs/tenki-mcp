...
try {
	...
	if (tools.length !== 70) throw new Error(`normal MCP request returned ${tools.length} tools; expected 70`);
	await client.close();

	console.log("✓ oversized chunked POST rejected with 413");
	console.log("✓ normal MCP initialization still advertises 70 tools");
} finally {
